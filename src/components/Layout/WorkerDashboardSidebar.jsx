...
const WorkerDashboardSidebar = ({ active }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Link to="/sales-history" className="w-full flex items-center">
          <FiShoppingBag
            size={30}
      ...
      >
        <Link to="/purchase-history" className="w-full flex items-center">
          <LuShoppingCart
            size={30}
      ...
      >
        <Link to="/all-product" className="w-full flex items-center">
          <FiPackage
            size={30}
  ...
  />
      ...
      {(isManajemenOpen || active === 4 || active === 5) && (
        <div>
          ...
          >
            <Link to="/all-member" className="w-full flex items-center">
              <MdOutlineVerified
                size={30}
